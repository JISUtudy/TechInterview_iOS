...
|앱이 foreground에 있을 때와 background에 있을 때 어떤 제약사항이 있나요?| [🙆🏻‍♀️](https://suzumsz.tistory.com/56) | - |
...
|NotificationCenter 동작 방식과 활용 방안에 대해 설명하시오.| - | [🙆🏻‍♂️](https://jiseok-zip.tistory.com/entry/iOSNotificationCenter?category=905419) |
...
|질문|수정|지석|
|:----------:|:-----:|:-----:|
|오토레이아웃을 코드로 작성하는 방법은 무엇인가? (3가지)| [🙆🏻‍♀️](https://suzumsz.tistory.com/58) | - |
...
|탈출 클로저에 대하여 설명하시오.| - | - |
|Extension에 대해 설명하시오.| [🙆🏻‍♀️](https://suzumsz.tistory.com/57) | - |
...
|순환 참조에 대하여 설명하시오.| - | [🙆🏻‍♂️](https://jiseok-zip.tistory.com/entry/iOSStrong과-weak-참조-방식?category=905419#toc-순환%20참조%20→%20메모리%20누수%20❓) |
